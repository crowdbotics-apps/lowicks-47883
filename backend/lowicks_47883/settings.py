"""
Django settings for lowicks_47883 project.
...
ROOT_URLCONF = 'lowicks_47883.urls'
...
WSGI_APPLICATION = 'lowicks_47883.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lowicks_47883 API",
    "DESCRIPTION": "API documentation for lowicks_47883 App",
    "VERSION": "v1",
}
